...
There are ‘r nrow(countData)’ genes in this dataset and ‘r
ncol(countData)’ experiments (samples)…

Look like there is a funny extra ‘length’ column in our couuntData that
we need to remove
...
A little bit more tidying work required. Lets remove the gene were we
have no data (i.e. zero counts in all experiments)

Let’s take the rowSum() and exclude the rows with zero values \!= not
equals
...
![](class-16_files/figure-gfm/unnamed-chunk-7-1.png)<!-- --> Lets add
some color…
...
![](class-16_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
```
    ...
    ## ENSG00000187634      SAMD11      148398      148398
    ## ENSG00000188976       NOC2L       26155       26155
    ## ENSG00000187961      KLHL17      339451      339451
    ## ENSG00000187583     PLEKHN1       84069       84069
    ## ENSG00000187642       PERM1       84808       84808
...
```
    ...
    ## Info: Working in directory C:/Users/cjstk/Desktop/bimm143/bimm143_github/class 16 02/27
